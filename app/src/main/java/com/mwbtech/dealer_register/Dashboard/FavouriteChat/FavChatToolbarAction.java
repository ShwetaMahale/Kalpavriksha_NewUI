...
public class FavChatToolbarAction implements ActionMode.Callback {
    Context context;
    ChatAdapter recyclerView_adapter;
    FavChatActivity recyclerFragment;
    ArrayList<Messages> message_models;

    AlertDialog.Builder builder;

    public FavChatToolbarAction(Context context, ChatAdapter recyclerView_adapter, FavChatActivity infofragment, ArrayList<Messages> message_model) {
