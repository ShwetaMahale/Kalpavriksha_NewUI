...
public class EnquiryReceivedChatToolbarAction implements ActionMode.Callback {
    Context context;
    ChatAdapter recyclerView_adapter;
    EnquiryReceivedChatActivity recyclerFragment;
    ArrayList<Messages> message_models;

    AlertDialog.Builder builder;

    public EnquiryReceivedChatToolbarAction(Context context, ChatAdapter recyclerView_adapter, EnquiryReceivedChatActivity infofragment, ArrayList<Messages> message_model) {
