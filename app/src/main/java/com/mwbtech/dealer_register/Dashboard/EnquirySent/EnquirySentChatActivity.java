...
public class EnquirySentChatActivity extends AppCompatActivity implements TextView.OnEditorActionListener, View.OnClickListener, /*MenuItem.OnMenuItemClickListener,*/ CustomerInfoDialog.BottomSheetListener {
    //Image
    ...
    //constant for pdf and image size
...
//        getSupportActionBar().setHomeButtonEnabled(true);
    ...
    private void showContent() {
        setContentView(R.layout.activity_outbox_chat);
        initializeViews();
...
//        setTitle("" + name);
    ...
    private void onListItemSelect(int position) {
        ...
        if (hasCheckedItems && mActionMode == null)
            ...
            mActionMode = startSupportActionMode(new EnquirySentChatToolbarAction(this, chatAdapter, this, msg_modelArrayList));
    ...
    public void deleteRows() {
        ...
        for (Messages messages : msgList) {
            ...
            deleteInboxes.add(new DeleteInbox(CustID, messages.getQueryId(), RecieverID, messages.getID()));
        }
        if (ConnectivityReceiver.isConnected()) {
    ...
    private void deleteIndividualConversion(List<DeleteInbox> deleteInboxes) {
        ...
        Gson gson=new Gson();
        Log.e("modelclass...",gson.toJson(deleteInboxes));
        ...
        call.enqueue(new Callback<DeleteInbox>() {
            ...
            public void onResponse(Call<DeleteInbox> call, Response<DeleteInbox> response) {
                ...
                switch (statusCode) {
                    ...
                    case 500:
                        //CustomToast.showToast(EnquirySentChatActivity.this, "Server Error");
                        break;

                    case 401:
                        SessionDialog.CallSessionTimeOutDialog(EnquirySentChatActivity.this);
                        break;
                }
            ...
            public void onFailure(Call<DeleteInbox> call, Throwable t) {
                if (t instanceof IOException) {
                    Toast.makeText(EnquirySentChatActivity.this, "Time out..", Toast.LENGTH_LONG).show();
                } else {
                    CustomToast.showToast(EnquirySentChatActivity.this, "Bad response from server.. Try again later ");
                }
            }
        });
    }
    ...
    private void getUserMessages() {
        ProgressDialog progressDialog = ShowProgressDialog.customProgressDialog(EnquirySentChatActivity.this, "Please wait");
            ...
            public void onResponse(Call<Msg_Model> call, Response<Msg_Model> response) {
                ...
                switch (status_code) {
                    case 200:
                        ...
                        chatAdapter = new ChatAdapter(msg_modelArrayList, EnquirySentChatActivity.this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.call:
                builder = new AlertDialog.Builder(EnquirySentChatActivity.this).setTitle("Call").setMessage(R.string.call).setIcon(R.drawable.phone);
    ...
    private void SendMessageToServer(String stringMsg, File imageFile, File pdfFile) {
        ...
        progressDialog.setCancelable(false);
        api_interface = Customer_Client.getClient().create(Customer_Interface.class);
        Messages messages = new Messages(QryId, CustID, toServerUnicodeEncoded, RecieverID, 1, "", CustID);
...
//        }
//        else {
            intent = new Intent(this, EnquirySentListDealerActivity.class);
//        }
        if(getIntent()!=null && getIntent().getExtras()!=null){
            intent.putExtra("CityID",getIntent().getExtras().getInt("CityID",0));
        }
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        EnquirySentChatActivity.this.finish();
    }
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EnquirySentChatActivity.this);
    ...
    private void dispatchTakePictureIntent() {
        ...
        //Intent picture=new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE_SECURE);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                ...
                ProjectUtilsKt.checkCameraPermission(EnquirySentChatActivity.this, (status -> {
    ...
    private File createDocFile() throws IOException {
        ...
        String timeStamp = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
        String mFileName = "PDF_" + timeStamp + "_";
        File storageDir = getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        File mFile = File.createTempFile(mFileName, ".pdf", storageDir);
        return mFile;
    }
    /**
