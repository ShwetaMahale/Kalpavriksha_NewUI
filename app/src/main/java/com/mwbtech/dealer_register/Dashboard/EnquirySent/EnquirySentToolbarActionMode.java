...
public class EnquirySentToolbarActionMode implements ActionMode.Callback {
    Context context;
    InboxAdapter recyclerView_adapter;
    EnquirySentListDealerActivity recyclerFragment;
    ArrayList<InboxDealer> message_models;

    AlertDialog.Builder builder;

    public EnquirySentToolbarActionMode(Context context, InboxAdapter recyclerView_adapter, EnquirySentListDealerActivity infofragment, ArrayList<InboxDealer> message_model) {
